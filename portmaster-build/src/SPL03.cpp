...
void SPL03::writeMem(std::uint32_t address, std::uint8_t value) {
    ...
    case 0xC4: toneA1_ = value; break;
    case 0xC6: toneA2_ = value; break;
    case 0xCC: noise1_ = value; break;
    case 0xCE: noise2_ = value; break;
    case 0xD0:
    ...
    case 0xD4: speechCtrl_ = value; break;
    case 0xD5: speechData_ = static_cast<std::uint8_t>(value & 0xBEU); break; // SPL03 masks D5 writes
